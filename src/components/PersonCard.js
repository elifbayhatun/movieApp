...
const PersonCard = ({person, title, personMovies}) => {
    ...
    <View
      ...
      <View>
        <View
          ...
          <View className="h-72 w-72 items-center rounded-full overflow-hidden border-neutral-500 border-2">
            <Image
              source={{
      ...
      <UpComingList data={personMovies} title="Movies" />
    </View>
  );
};
